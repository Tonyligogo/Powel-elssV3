...
export default function UserTable({rows, columns, onClickDelete}) {
    ...
    renderCell: (params) => {
      return (
        <div className='flex h-full items-center justify-center'>
          <Pencil size={18} style={{marginRight:'10px', cursor:'pointer'}}/>
          <Trash2 size={18} style={{ cursor:'pointer'}} onClick={()=>showDeleteModal(params.row.id)}/>
        </div>
      )
    }   
  }
